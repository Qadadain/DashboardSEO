 ...
 */
final class Version20200914122503 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, color VARCHAR(7) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE domain_name (id INT AUTO_INCREMENT NOT NULL, holder_id INT NOT NULL, name VARCHAR(255) NOT NULL, localisation VARCHAR(255) NOT NULL, expiration_date DATE DEFAULT NULL, color VARCHAR(7) DEFAULT NULL, INDEX IDX_F3FF5361DEEE62D0 (holder_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
